  ...
  return (
    ...
    <div className=" p-8 rounded-lg shadow-md bg-emerald-500 w-full md:w-1/2 ">
      ...
      <div>
         ...
         <div>
          <label htmlFor="course" className="block  text-zinc-950 font-bold">Course</label>
          <input
            id="course"
            type="text"
         ...
         <div>
          <label htmlFor="instuctor" className="block  text-zinc-950 font-bold">Instuctor</label>
          <input
            id="instuctor"
            type="text"
            {...register('instuctor', { required: 'Course is required' })}
            className="mt-1 block w-full px-3 py-2 bg-white text-zinc-950 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
